...
from myblog.sitemaps import ArticleSitemap, CategorySitemap, TagSitemap
from myblog.feeds import AllArticleRssFeed
...
urlpatterns = [
    ...
    # myblog
    url('', include('myblog.urls', namespace='blog')),  # blog
    # 评论
